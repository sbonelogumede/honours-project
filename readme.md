...
├── 09_plot_gp_predictions.R           # Plot GP predictions with 95% PI
...
# Step 9: Plot GP predictions
source("09_plot_gp_predictions.R")
```
...
### 9. Plot GP Predictions (`09_plot_gp_predictions.R`)

**Note: Run after step 8 is complete**

- Visualizes predictions from all three GP models (SE, Periodic, SE×Periodic)
- Creates faceted plots for all 7 CV folds (4×2 grid layout)
- Displays 95% prediction intervals as shaded regions
- Shows observed NO₂ levels as dashed black lines
- Calculates prediction interval coverage statistics
- Saves high-resolution PDF to `output/figures/`
...
- `run_analysis.R` executes steps 1-5 only; steps 6-9 are run separately
- Step 9 requires completion of step 8 to generate prediction plots
