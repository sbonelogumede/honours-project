...
## Looking ahead 
the multidimensional properties of Gaussian Process Regression can be extended to predict a group of commodity prices. While traditional models like ARIMA estimate commodities independently, GPR allows us to capture correlations between prices across different commodities.
